...
export function ResidentHeader({ residentName, activePage, onNavigate, onProfileClick, profileImage }: ResidentHeaderProps) {
              ...
              >
                {profileImage ? (
                  <img 
                    src={profileImage} 
                    alt="Profile" 
                    className="w-[43px] h-[43px] rounded-full object-cover border-2 border-[#2957a1]"
                  />
                ) : (
                  <img 
                    src={imgProfile} 
              ...
              >
                {profileImage ? (
                  <img 
                    src={profileImage} 
                    alt="Profile" 
                    className="w-[35px] h-[35px] rounded-full object-cover border-2 border-[#2957a1]"
                  />
                ) : (
                  <img 
                    src={imgProfile} 
