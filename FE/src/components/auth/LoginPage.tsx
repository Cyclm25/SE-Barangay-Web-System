...
// Define the shape of your official data for the frontend
interface Official {
  id: string;
  name: string;
  position: string;
      ...
      <div className="w-full max-w-[1920px] h-screen flex flex-col md:flex-row">
        ...
        <div className="md:w-[40%] bg-gradient-to-br from-blue-50 via-white to-blue-100 md:bg-[#2957a1] flex flex-col md:items-center md:justify-center relative md:p-8 h-screen">
          ...
          <div className="flex-1 w-full overflow-y-auto md:overflow-visible md:flex md:items-center md:justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100 md:bg-transparent">
            ...
            {mobileTab === 'login' && (
              <div className="md:hidden w-full flex flex-col items-center justify-center px-4 h-full pb-8">
                <div className="w-full max-w-[400px] bg-white rounded-[24px] p-8 shadow-2xl border border-gray-100 mt-4">
            ...
            {mobileTab === 'about' && (
              <div className="md:hidden w-full px-4 py-6 pb-12">
                <OfficialsList />
                {/* Note: You can optionally duplicate the other about cards here if you want them on mobile too! */}
              </div>
            )}
