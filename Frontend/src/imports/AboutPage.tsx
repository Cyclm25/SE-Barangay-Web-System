...
import imgImage25 from "figma:asset/93334e8cc40a99ba2240b1e53be900c9ce2a4203.png";
import imgImage26 from "figma:asset/b7a196a74e14dd7b38c0b991f625be0151863dce.png";
...
export default function AboutPage() {
  return (
    <div className="bg-white relative size-full" data-name="About Page">
      ...
      <div className="absolute h-[1269px] left-[-241px] opacity-75 top-[105px] w-[1847px]" data-name="image 25">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[158.02%] left-0 max-w-none top-[-58.02%] w-full" src={imgImage25} />
        </div>
      </div>
      ...
      <div className="absolute h-[464px] left-[840px] rounded-[28px] top-[160px] w-[348px]" data-name="image 26">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[28px] size-full" src={imgImage26} />
      </div>
