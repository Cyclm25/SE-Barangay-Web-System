...
Barangay Management
  ...
  return (
    <div className="p-10 space-y-10 bg-gray-50 min-h-full max-w-[1920px] mx-auto">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-5xl font-bold text-gray-900">Online Requests</h1>
          <p className="text-gray-600 mt-3 text-xl">Manage document requests from residents</p>
        </div>
        {/* Search Bar */}
        <div className="flex items-center gap-2">
