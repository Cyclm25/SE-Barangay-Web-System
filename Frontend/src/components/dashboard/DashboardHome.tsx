  ...
  return (
    <div className="p-12 space-y-12 bg-gray-50 min-h-full max-w-[1920px] mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-6xl font-bold text-gray-900">Dashboard Overview</h1>
          <p className="text-gray-600 mt-4 text-2xl">Welcome back, {adminName}!</p>
        </div>
        <div className="flex items-center gap-5 text-gray-600">
          <Clock className="w-9 h-9" />
          <span className="font-semibold text-2xl">{currentDateTime}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <Card className="border-[#51c55f] bg-white">
          <CardContent className="p-10">
            <p className="text-lg text-gray-700 mb-5">Total Registered Residents</p>
            <p className="text-5xl font-semibold text-[#2957a1]">{stats.totalResidents}</p>
          </CardContent>
        </Card>

        <Card className="border-[#51c55f] bg-white">
          <CardContent className="p-10">
            <p className="text-lg text-gray-700 mb-5">Total Registered Barangay Officials</p>
            <p className="text-5xl font-semibold text-[#2957a1]">{stats.totalOfficials}</p>
          </CardContent>
        </Card>

        <Card className="border-[#ffa62e] bg-white">
          <CardContent className="p-10">
            <p className="text-lg text-gray-700 mb-5">Pending Requests</p>
            <p className="text-5xl font-semibold text-[#2957a1]">{stats.pendingRequests}</p>
          </CardContent>
        </Card>

        <Card className="border-[#2dadfc] bg-white">
          <CardContent className="p-10">
            <p className="text-lg text-gray-700 mb-5">Documents to Pick Up</p>
            <p className="text-5xl font-semibold text-[#2957a1]">{stats.documentsToPickup}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <Card className="bg-white">
          <CardHeader className="pb-8">
            <CardTitle className="text-3xl text-gray-900">Resident Demographics</CardTitle>
          </CardHeader>
